...
function Box({ size, className = '', style, ...otherProps }) {
  ...
  return <div className={`box ${className} ${sizeClassName}`} {...otherProps} style={{ fontStyle: 'italic', ...style }} >{otherProps.children}</div>
}
...
function App() {
  return (
    <div>
      ...
      <Box size='medium' style={{ backgroundColor: 'pink' }} >medium pinx box</Box>
